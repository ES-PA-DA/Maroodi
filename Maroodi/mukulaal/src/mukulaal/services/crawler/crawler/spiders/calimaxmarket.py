...
class CalimaxmarketSpider(scrapy.Spider):
    ...
    def parse_items(self, response):
        ...
        for i in items:
            ...
            price_label = i.css("span.vtex-product-price-1-x-sellingPrice--summary")
            price_int_label = price_label.css("span.vtex-product-price-1-x-currencyInteger--summary::text").get()
            price_frac_label = price_label.css("span.vtex-product-price-1-x-currencyFraction--summary::text").get()
